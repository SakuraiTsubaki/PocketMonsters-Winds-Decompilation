...
This roadmap defines the recommended order for turning this planned repository into a reproducible decompilation project once authoritative target material and versions are available.

## Phase 0 — Target definition
- [ ] Identify authoritative game versions, regions, languages, revisions, updates, and platforms.
- [ ] Record hashes and provenance for each supported target.
- [ ] Define the primary matching target only after verification.

## Phase 1 — Binary and container mapping
- [ ] Document executable layout, sections, archives, and resource containers.
